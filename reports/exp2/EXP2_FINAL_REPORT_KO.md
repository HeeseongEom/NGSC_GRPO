...
Conditional−Static은 internal에서 0/4, external에서 2/4 backbone만 양수였다. External target은 action/reward/state/checkpoint 선택에 사용하지 않았다. Global과 Conditional은 모두 3 seeds 평균이다.
...
| Backbone | Static | Oracle | Oracle−Static | Reward gain | Oracle−Final Cond |
|---|---:|---:|---:|---:|---:|
| MaskCLIP | 56.008 | 64.284 | +8.275 | +7.384 | +8.518 |
| SCLIP | 55.456 | 61.974 | +6.518 | +7.117 | +6.519 |
| ClearCLIP | 55.437 | 64.947 | +9.510 | +9.823 | +9.682 |
| NACLIP | 53.089 | 62.505 | +9.416 | +9.252 | +11.223 |
...
| Backbone | Best source-val mIoU | Best update |
|---|---:|---:|
| MaskCLIP | 51.989 | 60 |
| SCLIP | 47.340 | 80 |
| ClearCLIP | 50.796 | 200 |
| NACLIP | 48.008 | 80 |
...
| Backbone | Hard | Soft IoU | Soft IoU+Youden |
|---|---:|---:|---:|
| MaskCLIP | 51.935 | 51.922 | 51.792 |
| SCLIP | 47.161 | 47.171 | 47.174 |
| ClearCLIP | 50.588 | 50.416 | 50.497 |
| NACLIP | 48.353 | 48.478 | 48.218 |
| Macro | 49.509 | 49.497 | 49.420 |
...
| Action set | Reward | Source-val macro mIoU | 결정 |
|---|---:|---:|---:|
| eta | soft_iou_youden | 46.602 |  |
| eta_q | soft_full | 38.358 |  |
| full4 | soft_iou_youden | 49.420 | 선택 |
| full5q | soft_full | 38.989 |  |
...
| Policy | State | LODO macro mIoU | 결정 |
|---|---:|---:|---:|
| global | base11 | 50.198 |  |
| conditional | base11 | 50.279 |  |
| conditional | prompt12 | 50.398 | 선택 |
...
|---|---:|---:|---:|---:|
| MaskCLIP | 39.061 (+1.196) | 65.310 (-1.828) | 58.644 (-0.958) | 60.049 (+0.621) |
| SCLIP | 38.145 (-0.055) | 67.639 (+0.027) | 57.221 (+0.001) | 58.814 (+0.024) |
| ClearCLIP | 35.381 (+1.909) | 66.593 (-3.232) | 60.148 (+0.340) | 58.940 (+0.298) |
| NACLIP | 35.314 (+0.245) | 55.770 (-8.654) | 57.818 (-0.562) | 56.224 (+1.741) |

External zero-shot:

| Backbone | Covid X-ray | MedSeg CT | HAM10000 | PH2 |
|---|---:|---:|---:|---:|
| MaskCLIP | 57.291 (+1.861) | 30.795 (-1.541) | 15.080 (-0.487) | 20.593 (+0.204) |
| SCLIP | 49.869 (+0.049) | 29.988 (-0.019) | 16.455 (+0.170) | 24.172 (+0.676) |
| ClearCLIP | 54.027 (+0.027) | 29.170 (-1.042) | 15.819 (-0.625) | 21.191 (-1.005) |
| NACLIP | 54.130 (+0.399) | 26.956 (-1.942) | 14.745 (-0.905) | 19.335 (-4.916) |
...
| Policy | Backbone | Reward first→last | Best val | Best updates | Final KL | Max \|ratio−1\| | Max clip frac |
|---|---:|---:|---:|---:|---:|---:|---:|
| global | MaskCLIP | 0.5750→0.5779 | 51.798 | 75,75,100 | 0.231 | 0.011 | 0.000 |
| global | SCLIP | 0.5493→0.5471 | 47.196 | 25,1,25 | 0.506 | 0.016 | 0.000 |
| global | ClearCLIP | 0.5774→0.5744 | 50.308 | 450,400,500 | 0.186 | 0.013 | 0.000 |
| global | NACLIP | 0.5270→0.5291 | 48.156 | 275,225,225 | 0.199 | 0.013 | 0.000 |
| conditional | MaskCLIP | 0.5781→0.5893 | 52.015 | 275,200,300 | 0.820 | 0.163 | 0.000 |
| conditional | SCLIP | 0.5511→0.5307 | 47.261 | 25,1,1 | 7.166 | 0.122 | 0.000 |
| conditional | ClearCLIP | 0.5797→0.5830 | 51.994 | 500,500,475 | 0.684 | 0.161 | 0.000 |
| conditional | NACLIP | 0.5314→0.5435 | 49.422 | 475,475,75 | 1.494 | 0.185 | 0.000 |
...
| Backbone | Source-Static | Global mean | Conditional mean (within-pair σ) |
|---|---:|---:|---:|
| MaskCLIP | 1.295/0.718/0.402/2.664 | 1.326/0.718/0.411/2.677 | 1.349/0.716/0.427/2.683 (σ=0.174/0.030/0.039/0.056) |
| SCLIP | 1.222/0.780/0.677/1.877 | 1.230/0.782/0.679/1.884 | 1.224/0.780/0.678/1.882 (σ=0.018/0.003/0.005/0.016) |
| ClearCLIP | 1.222/0.780/0.677/1.877 | 1.323/0.811/0.703/1.932 | 1.316/0.824/0.703/1.951 (σ=0.236/0.046/0.042/0.206) |
| NACLIP | 0.827/0.951/0.571/3.580 | 0.866/0.939/0.582/3.582 | 0.886/0.925/0.589/3.574 (σ=0.226/0.034/0.053/0.085) |
